    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <button @click="descargarPDF" class="bg-red-500 hover:bg-red-600 text-white px-5 py-2 rounded-xl font-black uppercase text-[10px] tracking-widest shadow-lg transition-all flex items-center gap-2">
